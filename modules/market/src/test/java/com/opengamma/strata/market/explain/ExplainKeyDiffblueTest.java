...
class ExplainKeyDiffblueTest {
  /**
   * Test {@link ExplainKey#of(String)}.
   *
   * <ul>
   *   <li>When {@code Name}.
   ...
   * </ul>
   *
   * <p>Method under test: {@link ExplainKey#of(String)}
   */
  @Test
  @DisplayName("Test of(String); when 'Name'; then return 'Name'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"ExplainKey ExplainKey.of(String)"})
  void testOf_whenName_thenReturnName() {
    // Arrange and Act
    ExplainKey<Object> actualOfResult = ExplainKey.of("Name");
