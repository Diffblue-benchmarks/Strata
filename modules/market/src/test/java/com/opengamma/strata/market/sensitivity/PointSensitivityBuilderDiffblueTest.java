...
class PointSensitivityBuilderDiffblueTest {
  /**
   * Test {@link PointSensitivityBuilder#none()}.
   *
   * <p>Method under test: {@link PointSensitivityBuilder#none()}
   */
  @Test
  @DisplayName("Test none()")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"PointSensitivityBuilder PointSensitivityBuilder.none()"})
  void testNone() {
    // Arrange and Act
    PointSensitivityBuilder actualNoneResult = PointSensitivityBuilder.none();

    // Assert
    assertTrue(actualNoneResult instanceof NoPointSensitivity);
    PointSensitivities pointSensitivities = actualNoneResult.build();
   ...
   */
  @Test
  @DisplayName("Test multipliedBy(double); then return MutablePointSensitivities()")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"PointSensitivityBuilder PointSensitivityBuilder.multipliedBy(double)"})
  void testMultipliedBy_thenReturnMutablePointSensitivities() {
    // Arrange
  ...
  /**
   * Test {@link PointSensitivityBuilder#combinedWith(PointSensitivityBuilder)}.
   *
   * <ul>
   *   <li>Given {@link NoPointSensitivity#INSTANCE}.
   *   <li>Then return {@link MutablePointSensitivities#MutablePointSensitivities()}.
   * </ul>
   *
   * <p>Method under test: {@link PointSensitivityBuilder#combinedWith(PointSensitivityBuilder)}
   */
  @Test
  @DisplayName(
      "Test combinedWith(PointSensitivityBuilder); given INSTANCE; then return MutablePointSensitivities()")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "PointSensitivityBuilder PointSensitivityBuilder.combinedWith(PointSensitivityBuilder)"
  })
  void testCombinedWith_givenInstance_thenReturnMutablePointSensitivities() {
    // Arrange
    MutablePointSensitivities other = new MutablePointSensitivities();

    // Act
    PointSensitivityBuilder actualCombinedWithResult =
        NoPointSensitivity.INSTANCE.combinedWith(other);
   ...
   *
   * <ul>
   *   <li>Given {@link MutablePointSensitivities#MutablePointSensitivities()}.
   * </ul>
   *
   * <p>Method under test: {@link PointSensitivityBuilder#combinedWith(PointSensitivityBuilder)}
   */
  @Test
  @DisplayName("Test combinedWith(PointSensitivityBuilder); given MutablePointSensitivities()")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "PointSensitivityBuilder PointSensitivityBuilder.combinedWith(PointSensitivityBuilder)"
  })
  void testCombinedWith_givenMutablePointSensitivities() {
    // Arrange
    MutablePointSensitivities mutablePointSensitivities = new MutablePointSensitivities();
