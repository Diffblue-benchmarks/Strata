...
class DiscountFactorQuadraticLeftZeroRateCurveExtrapolatorDiffblueTest {
  /**
   * Test Bound {@link DiscountFactorQuadraticLeftZeroRateCurveExtrapolator.Bound#Bound(DoubleArray,
   ...
   * DiscountFactorQuadraticLeftZeroRateCurveExtrapolator.Bound#Bound(DoubleArray, DoubleArray,
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "void DiscountFactorQuadraticLeftZeroRateCurveExtrapolator.Bound.<init>(DoubleArray, DoubleArray, BoundCurveInterpolator)"
  })
  void testBoundNewBound_givenTen_thenCallsDoFirstDerivative() {
    ...
    // Act
    new DiscountFactorQuadraticLeftZeroRateCurveExtrapolator.Bound(xValues, yValues, interpolator);
