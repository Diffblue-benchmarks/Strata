...
class PresentValueCalibrationMeasureDiffblueTest {
  /**
   * Test {@link PresentValueCalibrationMeasure#of(String, Class, ToDoubleBiFunction, BiFunction)}.
   *
   * <ul>
   ...
   * </ul>
   *
   * <p>Method under test: {@link PresentValueCalibrationMeasure#of(String, Class,
   * ToDoubleBiFunction, BiFunction)}
   */
  @Test
  @DisplayName(
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "PresentValueCalibrationMeasure PresentValueCalibrationMeasure.of(String, Class, ToDoubleBiFunction, BiFunction)"
  })
  void testOf_whenToDoubleBiFunction_thenReturnToStringIsName() {
    ...
    // Act
    PresentValueCalibrationMeasure<ResolvedTrade> actualOfResult =
   ...
   *
   * <ul>
   *   <li>{@link PresentValueCalibrationMeasure#getTradeType()}
   *   <li>{@link PresentValueCalibrationMeasure#toString()}
   * </ul>
   */
  @Test
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "Class PresentValueCalibrationMeasure.getTradeType()",
    "String PresentValueCalibrationMeasure.toString()"
  })
  void testGettersAndSetters() {
    // Arrange
    Class<ResolvedTrade> tradeType = ResolvedTrade.class;
    PresentValueCalibrationMeasure<ResolvedTrade> ofResult =
        PresentValueCalibrationMeasure.of(
            "Name", tradeType, mock(ToDoubleBiFunction.class), mock(BiFunction.class));
  ...
  /**
   * Test {@link PresentValueCalibrationMeasure#value(ResolvedTrade, RatesProvider)}.
   *
   * <ul>
   ...
   * </ul>
   *
   * <p>Method under test: {@link PresentValueCalibrationMeasure#value(ResolvedTrade,
   * RatesProvider)}
   */
  @Test
  @DisplayName(
  ...
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"double PresentValueCalibrationMeasure.value(ResolvedTrade, RatesProvider)"})
  void testValue_givenToDoubleBiFunctionApplyAsDoubleReturnTen_whenNull_thenReturnTen() {
    ...
    PresentValueCalibrationMeasure<ResolvedTrade> ofResult =
        PresentValueCalibrationMeasure.of("Name", tradeType, valueFn, mock(BiFunction.class));
  ...
  /**
   * Test {@link PresentValueCalibrationMeasure#sensitivities(ResolvedTrade, RatesProvider)}.
   *
   * <ul>
   ...
   * </ul>
   *
   * <p>Method under test: {@link PresentValueCalibrationMeasure#sensitivities(ResolvedTrade,
   * RatesProvider)}
   */
  @Test
  @DisplayName(
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "CurrencyParameterSensitivities PresentValueCalibrationMeasure.sensitivities(ResolvedTrade, RatesProvider)"
  })
  void testSensitivities_givenBiFunctionApplyReturnEmpty_whenNull_thenReturnSizeIsZero() {
    ...
    PresentValueCalibrationMeasure<ResolvedTrade> ofResult =
        PresentValueCalibrationMeasure.of(
            "Name", tradeType, mock(ToDoubleBiFunction.class), sensitivityFn);
