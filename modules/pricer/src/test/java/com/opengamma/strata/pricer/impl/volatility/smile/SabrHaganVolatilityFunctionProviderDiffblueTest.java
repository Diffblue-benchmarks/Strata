...
class SabrHaganVolatilityFunctionProviderDiffblueTest {
  ...
  void testVolatilityAdjointWithDoubleDoubleDoubleSabrFormulaData3() {
    ...
    assertEquals(1.4006842404562026E17d, derivatives.max());
    assertEquals(1.4006842404562026E17d, toListResult.get(0).doubleValue());
    assertEquals(1.8427479136705587E17d, derivatives.sum());
