...
class BlackBarrierPriceFormulaRepositoryDiffblueTest {
   ...
   *
   * <ul>
   *   <li>Then return {@code 1.0265398334010448E-47}.
   * </ul>
   *
   * <p>Method under test: {@link BlackBarrierPriceFormulaRepository#price(double, double, double,
   * double, double, double, boolean, SimpleConstantContinuousBarrier)}
  ...
  @Test
  @DisplayName(
      "Test price(double, double, double, double, double, double, boolean, SimpleConstantContinuousBarrier); then return '1.0265398334010448E-47'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "double BlackBarrierPriceFormulaRepository.price(double, double, double, double, double, double, boolean, SimpleConstantContinuousBarrier)"
  })
  void testPrice_thenReturn10265398334010448e47() {
    // Arrange
    BlackBarrierPriceFormulaRepository blackBarrierPriceFormulaRepository =
        new BlackBarrierPriceFormulaRepository();
  ...
  void testPriceAdjoint4() {
    ...
    assertEquals(0.0033090359095341096d, toListResult.get(5).doubleValue());
  ...
  void testPriceAdjoint5() {
    ...
    assertEquals(-6.75825953109189E-82d, toListResult.get(1).doubleValue());
  ...
  void testPriceAdjoint10() {
    ...
    List<Double> toListResult = derivatives.toList();
    assertEquals(7, toListResult.size());
    assertEquals(-1.0629032373830292E-81d, toListResult.get(6).doubleValue());
    assertEquals(-4.8563552642405595E-80d, derivatives.min());
    assertEquals(-4.8563552642405595E-80d, toListResult.get(1).doubleValue());
    assertEquals(4.8521524893620275E-78d, toListResult.get(5).doubleValue());
    assertEquals(4.856355264240558E-78d, derivatives.max());
    assertEquals(5.310313412036609E-80d, toListResult.get(0).doubleValue());
    assertEquals(9.70357888208606E-78d, derivatives.sum());
    assertArrayEquals(
        new double[] {
          5.310313412036609E-80d,
          -4.8563552642405595E-80d,
          4.856355264240558E-78d,
          4.184180645282347E-92d,
          -8.405549757144863E-81d,
          4.8521524893620275E-78d,
          -1.0629032373830292E-81d
        },
        derivatives.toArrayUnsafe(),
        0.0);
  }
  ...
  void testPriceAdjoint12() {
    ...
    List<Double> toListResult = derivatives.toList();
    assertEquals(7, toListResult.size());
    assertEquals(-1.0265398334010448E-46d, toListResult.get(5).doubleValue());
    ...
    assertEquals(1.0265398334010448E-47d, actualPriceAdjointResult.getValue());
    assertEquals(1.0265398334010448E-48d, toListResult.get(1).doubleValue());
    ...
    assertArrayEquals(
        new double[] {
          ...
          1.0265398334010448E-48d,
          -1.0265398334010448E-46d,
          2.694125743053722E-48d,
          -5.388251486107444E-48d,
          -1.0265398334010448E-46d,
  ...
  void testPriceAdjoint_thenReturnDerivativesMinIs3720075976020836e42() {
    ...
    assertEquals(-5.310313412036585E-80d, toListResult.get(0).doubleValue());
    assertEquals(-7.402951192281462E-42d, derivatives.sum());
    assertEquals(1.9099420742041869E-81d, toListResult.get(6).doubleValue());
    assertEquals(3.720075976020836E-44d, derivatives.max());
    assertEquals(3.720075976020836E-44d, toListResult.get(1).doubleValue());
    assertArrayEquals(
        new double[] {
          -5.310313412036585E-80d,
          3.720075976020836E-44d,
          -3.720075976020836E-42d,
          -1.7585686770027256E-92d,
          8.478793917968728E-78d,
          -3.720075976020836E-42d,
          1.9099420742041869E-81d
        },
        derivatives.toArrayUnsafe(),
        0.0);
  }
  ...
  void testPriceAdjoint_thenReturnDerivativesToListFirstDoubleValueIs000549280271653059() {
    ...
    assertEquals(-2.0370202373596214E-80d, toListResult.get(1).doubleValue());
    ...
    assertEquals(6.196875809988251E-78d, toListResult.get(5).doubleValue());
    assertEquals(6.591363259836709E-4d, toListResult.get(6).doubleValue());
    assertArrayEquals(
        new double[] {
          -0.00549280271653059d,
          -2.0370202373596214E-80d,
          -2.7464013582652944d,
          2.7299463918951186d,
          0.03290993274035144d,
          6.196875809988251E-78d,
          6.591363259836709E-4d
        },
        derivatives.toArrayUnsafe(),
        0.0);
