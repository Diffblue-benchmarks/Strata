...
class TradeCalibrationMeasureDiffblueTest {
  /**
   * Test {@link TradeCalibrationMeasure#of(String, Class, ToDoubleBiFunction, BiFunction)}.
   *
   * <ul>
   ...
   * </ul>
   *
   * <p>Method under test: {@link TradeCalibrationMeasure#of(String, Class, ToDoubleBiFunction,
   * BiFunction)}
   */
  @Test
  @DisplayName(
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "TradeCalibrationMeasure TradeCalibrationMeasure.of(String, Class, ToDoubleBiFunction, BiFunction)"
  })
  void testOf_whenToDoubleBiFunction_thenReturnToStringIsName() {
    ...
    // Act
    TradeCalibrationMeasure<ResolvedTrade> actualOfResult =
   ...
   *
   * <ul>
   *   <li>{@link TradeCalibrationMeasure#getTradeType()}
   *   <li>{@link TradeCalibrationMeasure#toString()}
   * </ul>
   */
  @Test
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "Class TradeCalibrationMeasure.getTradeType()",
    "String TradeCalibrationMeasure.toString()"
  })
  void testGettersAndSetters() {
    // Arrange
    Class<ResolvedTrade> tradeType = ResolvedTrade.class;
    TradeCalibrationMeasure<ResolvedTrade> ofResult =
        TradeCalibrationMeasure.of(
            "Name", tradeType, mock(ToDoubleBiFunction.class), mock(BiFunction.class));
  ...
  /**
   * Test {@link TradeCalibrationMeasure#value(ResolvedTrade, RatesProvider)}.
   *
   * <ul>
   ...
   * </ul>
   *
   * <p>Method under test: {@link TradeCalibrationMeasure#value(ResolvedTrade, RatesProvider)}
   */
  @Test
  @DisplayName(
  ...
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"double TradeCalibrationMeasure.value(ResolvedTrade, RatesProvider)"})
  void testValue_givenToDoubleBiFunctionApplyAsDoubleReturnTen_whenNull_thenReturnTen() {
    ...
    TradeCalibrationMeasure<ResolvedTrade> ofResult =
        TradeCalibrationMeasure.of("Name", tradeType, valueFn, mock(BiFunction.class));
  ...
  /**
   * Test {@link TradeCalibrationMeasure#sensitivities(ResolvedTrade, RatesProvider)}.
   *
   * <ul>
   ...
   * </ul>
   *
   * <p>Method under test: {@link TradeCalibrationMeasure#sensitivities(ResolvedTrade,
   * RatesProvider)}
   */
  @Test
  @DisplayName(
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "CurrencyParameterSensitivities TradeCalibrationMeasure.sensitivities(ResolvedTrade, RatesProvider)"
  })
