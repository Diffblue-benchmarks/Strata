...
class BlackFormulaRepositoryDiffblueTest {
   ...
   * <ul>
   *   <li>When {@code 0.5}.
   *   <li>Then return {@code 1.4035922178528375E218}.
   * </ul>
   *
  ...
  @Test
  @DisplayName(
      "Test strikeForDelta(double, double, double, double, boolean); when '0.5'; then return '1.4035922178528375E218'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "double BlackFormulaRepository.strikeForDelta(double, double, double, double, boolean)"
  })
  void testStrikeForDelta_when05_thenReturn14035922178528375e218() {
    // Arrange and Act
    double actualStrikeForDeltaResult =
        BlackFormulaRepository.strikeForDelta(10.0d, 0.5d, 10.0d, 10.0d, true);

    // Assert
    assertEquals(1.4035922178528375E218d, actualStrikeForDeltaResult);
  }
  ...
  void testImpliedVolatilityAdjointWithOtmPriceForwardStrikeTimeToExpiryVolGuess9() {
    ...
    // Assert
    assertEquals(0.5530007581933459d, actualImpliedVolatilityAdjointResult.getValue());
    DoubleArray derivatives = actualImpliedVolatilityAdjointResult.getDerivatives();
    List<Double> toListResult = derivatives.toList();
    assertEquals(1, toListResult.size());
    assertEquals(8.982386226195014E12d, derivatives.max());
    assertEquals(8.982386226195014E12d, derivatives.min());
    assertEquals(8.982386226195014E12d, derivatives.sum());
    assertEquals(8.982386226195014E12d, toListResult.get(0).doubleValue());
    assertArrayEquals(new double[] {8.982386226195014E12d}, derivatives.toArrayUnsafe(), 0.0);
  }
  ...
  void testImpliedVolatilityAdjointWithPriceForwardStrikeTimeToExpiryIsCall11() {
    ...
    List<Double> toListResult = derivatives.toList();
    assertEquals(1, toListResult.size());
    assertEquals(6.725350495905468E13d, derivatives.max());
    assertEquals(6.725350495905468E13d, derivatives.min());
    assertEquals(6.725350495905468E13d, derivatives.sum());
    assertEquals(6.725350495905468E13d, toListResult.get(0).doubleValue());
    assertArrayEquals(new double[] {6.725350495905468E13d}, derivatives.toArrayUnsafe(), 0.0);
  }
  ...
  void testImpliedStrikeWithDeltaIsCallForwardTimeVolatility() {
    ...
    // Assert
    assertEquals(1.4035922178528375E218d, actualImpliedStrikeResult);
  }
  ...
  void testImpliedStrikeWithDeltaIsCallForwardTimeVolatilityDerivatives() {
    ...
    assertArrayEquals(
        new double[] {
          -1.1125790703447027E220d,
          1.4035922178528375E217d,
          7.017961089264188E219d,
          1.4035922178528376E220d
        },
        derivatives,
        0.0);
  }
