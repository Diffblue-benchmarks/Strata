...
class SabrHaganNormalVolatilityFormulaDiffblueTest {
  ...
  void testVolatilityAdjoint() {
    ...
    assertEquals(5.5206840637983392E17d, derivatives.max());
    assertEquals(5.5206840637983392E17d, toListResult.get(0).doubleValue());
    assertEquals(6517183.842074845d, derivatives.min());
    assertEquals(6517183.842074845d, toListResult.get(5).doubleValue());
    assertEquals(7.2515811923822861E17d, derivatives.sum());
    assertArrayEquals(
        new double[] {
          5.5206840637983392E17d,
          4.5097362143042136E16d,
          1.0746819718976362E16d,
          1.17243377076017056E17d,
  ...
  void testVolatilityAdjoint_when099999_thenReturnDerivativesMinIs4546159875389375e11() {
    ...
    assertEquals(7.2515551071229914E17d, derivatives.sum());
    assertArrayEquals(
        new double[] {
          4.509736214328508E16d,
          5.5206840638280186E17d,
          1.0746819719034714E16d,
          1.17243377076662432E17d,
  ...
  void testVolatilityAdjoint_whenZero_thenReturnDerivativesMinIs16666666666666665e12() {
    ...
    assertEquals(4.666666666666666E32d, toListResult.get(0).doubleValue());
    assertEquals(4.666666666666666E32d, toListResult.get(1).doubleValue());
    assertArrayEquals(
        new double[] {
          4.666666666666666E32d,
          4.666666666666666E32d,
