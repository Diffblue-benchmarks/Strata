...
class ImpliedTrinomialTreeLocalVolatilityCalculatorDiffblueTest {
  ...
  void testLocalVolatilityFromImpliedVolatility3() {
    ...
    assertEquals(2.090032106190605E16d, zValues.max());
    assertEquals(2.090032106190605E16d, toListResult.get(1).doubleValue());
    assertEquals(3.567907981375584E16d, zValues.sum());
    assertArrayEquals(
        new double[] {1.477875875184979E16d, 2.090032106190605E16d}, zValues.toArrayUnsafe(), 0.0);
    assertArrayEquals(
  ...
  void testLocalVolatilityFromImpliedVolatility4() {
    ...
    assertEquals(3.5007348237603436E11d, zValues.max());
  ...
  void testLocalVolatilityFromImpliedVolatility5() {
    ...
    assertArrayEquals(
        new double[] {1.477875875184979E16d, 2.090032106190605E16d},
  ...
  void testLocalVolatilityFromImpliedVolatility_thenReturnYValuesToListSizeIsTen() {
    ...
    assertEquals(2.6766670272505916E58d, yValues.max());
    assertEquals(2.6766670272574307E58d, yValues.sum());
    assertEquals(3.500734823760344E11d, zValues.max());
   ...
   *
   * <ul>
   *   <li>Then return DiscountFactor min is {@code 0.6376281516217726}.
   * </ul>
   *
   * <p>Method under test: {@link
   * ImpliedTrinomialTreeLocalVolatilityCalculator#calibrateImpliedVolatility(Function, double,
  ...
  @Test
  @DisplayName(
      "Test calibrateImpliedVolatility(Function, double, Function, Function); then return DiscountFactor min is '0.6376281516217726'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "RecombiningTrinomialTreeData ImpliedTrinomialTreeLocalVolatilityCalculator.calibrateImpliedVolatility(Function, double, Function, Function)"
  })
  void testCalibrateImpliedVolatility_thenReturnDiscountFactorMinIs06376281516217726() {
    // Arrange
    ImpliedTrinomialTreeLocalVolatilityCalculator impliedTrinomialTreeLocalVolatilityCalculator =
        new ImpliedTrinomialTreeLocalVolatilityCalculator();
    ...
    verify(impliedVolatilitySurface, atLeast(1)).apply(Mockito.<DoublesPair>any());
    DoubleArray discountFactor = actualCalibrateImpliedVolatilityResult.getDiscountFactor();
    assertEquals(0.6376281516217726d, discountFactor.min());
