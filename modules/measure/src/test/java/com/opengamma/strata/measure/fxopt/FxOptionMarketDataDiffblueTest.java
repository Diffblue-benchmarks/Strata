...
class FxOptionMarketDataDiffblueTest {
  /**
   * Test {@link FxOptionMarketData#getValuationDate()}.
   *
   * <ul>
   *   <li>Then return toString is {@code 1970-01-01}.
   * </ul>
   *
   * <p>Method under test: {@link FxOptionMarketData#getValuationDate()}
   */
  @Test
  @DisplayName("Test getValuationDate(); then return toString is '1970-01-01'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"LocalDate FxOptionMarketData.getValuationDate()"})
  void testGetValuationDate_thenReturnToStringIs19700101() {
    ...
    LocalDate actualValuationDate =
        DefaultFxOptionMarketData.of(
                DefaultFxOptionMarketDataLookup.of(new HashMap<>()), marketData)
            .getValuationDate();
