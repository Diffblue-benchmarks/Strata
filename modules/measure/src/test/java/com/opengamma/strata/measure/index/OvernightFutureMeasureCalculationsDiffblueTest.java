...
class OvernightFutureMeasureCalculationsDiffblueTest {
  /**
   * Test {@link OvernightFutureMeasureCalculations#pv01CalibratedSum(ResolvedOvernightFutureTrade,
   ...
   * OvernightFutureMeasureCalculations#pv01CalibratedSum(ResolvedOvernightFutureTrade,
   * RatesScenarioMarketData)}
   */
  @Test
  @DisplayName(
      "Test pv01CalibratedSum(ResolvedOvernightFutureTrade, RatesScenarioMarketData) with 'trade', 'marketData'; given zero; then return Amounts Size is zero")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "MultiCurrencyScenarioArray OvernightFutureMeasureCalculations.pv01CalibratedSum(ResolvedOvernightFutureTrade, RatesScenarioMarketData)"
  })
  void testPv01CalibratedSumWithTradeMarketData_givenZero_thenReturnAmountsSizeIsZero() {
    ...
    MultiCurrencyScenarioArray actualPv01CalibratedSumResult =
        OvernightFutureMeasureCalculations.DEFAULT.pv01CalibratedSum(null, marketData);
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "MultiCurrencyAmount OvernightFutureMeasureCalculations.pv01CalibratedSum(ResolvedOvernightFutureTrade, RatesProvider)"
  })
  void testPv01CalibratedSumWithTradeRatesProvider_thenCallsParameterSensitivity() {
    ...
    OvernightFutureMeasureCalculations overnightFutureMeasureCalculations =
        new OvernightFutureMeasureCalculations(tradePricer);
    ...
    MultiCurrencyAmount actualPv01CalibratedSumResult =
        overnightFutureMeasureCalculations.pv01CalibratedSum(null, ratesProvider);
  ...
  void testPv01CalibratedSumWithTradeRatesProvider_thenReturnSizeIsZero() {
    ...
    // Act
    MultiCurrencyAmount actualPv01CalibratedSumResult =
        overnightFutureMeasureCalculations.pv01CalibratedSum(null, new MockRatesProvider());
  ...
  /**
   * Test {@link
   * OvernightFutureMeasureCalculations#pv01CalibratedBucketed(ResolvedOvernightFutureTrade,
   * RatesScenarioMarketData)} with {@code trade}, {@code marketData}.
   *
   * <p>Method under test: {@link
   * OvernightFutureMeasureCalculations#pv01CalibratedBucketed(ResolvedOvernightFutureTrade,
  ...
  @Test
  @DisplayName(
      "Test pv01CalibratedBucketed(ResolvedOvernightFutureTrade, RatesScenarioMarketData) with 'trade', 'marketData'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "ScenarioArray OvernightFutureMeasureCalculations.pv01CalibratedBucketed(ResolvedOvernightFutureTrade, RatesScenarioMarketData)"
  })
  void testPv01CalibratedBucketedWithTradeMarketData() {
    ...
    ScenarioArray<CurrencyParameterSensitivities> actualPv01CalibratedBucketedResult =
        overnightFutureMeasureCalculations.pv01CalibratedBucketed(null, marketData);
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "CurrencyParameterSensitivities OvernightFutureMeasureCalculations.pv01CalibratedBucketed(ResolvedOvernightFutureTrade, RatesProvider)"
  })
  void testPv01CalibratedBucketedWithTradeRatesProvider_givenEmpty_thenReturnEmpty() {
    ...
    CurrencyParameterSensitivities actualPv01CalibratedBucketedResult =
        overnightFutureMeasureCalculations.pv01CalibratedBucketed(null, ratesProvider);
  ...
  void testPv01CalibratedBucketedWithTradeRatesProvider_thenReturnSizeIsZero() {
    ...
    // Act
    CurrencyParameterSensitivities actualPv01CalibratedBucketedResult =
        overnightFutureMeasureCalculations.pv01CalibratedBucketed(null, new MockRatesProvider());
  ...
  /**
   * Test {@link OvernightFutureMeasureCalculations#pv01MarketQuoteSum(ResolvedOvernightFutureTrade,
   * RatesScenarioMarketData)} with {@code trade}, {@code marketData}.
   *
   * <ul>
   *   <li>Given zero.
   ...
   *
   * <p>Method under test: {@link
   * OvernightFutureMeasureCalculations#pv01MarketQuoteSum(ResolvedOvernightFutureTrade,
   * RatesScenarioMarketData)}
   */
  @Test
  @DisplayName(
      "Test pv01MarketQuoteSum(ResolvedOvernightFutureTrade, RatesScenarioMarketData) with 'trade', 'marketData'; given zero; then return Amounts Size is zero")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "MultiCurrencyScenarioArray OvernightFutureMeasureCalculations.pv01MarketQuoteSum(ResolvedOvernightFutureTrade, RatesScenarioMarketData)"
  })
  void testPv01MarketQuoteSumWithTradeMarketData_givenZero_thenReturnAmountsSizeIsZero() {
    ...
    MultiCurrencyScenarioArray actualPv01MarketQuoteSumResult =
        OvernightFutureMeasureCalculations.DEFAULT.pv01MarketQuoteSum(null, marketData);
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "MultiCurrencyAmount OvernightFutureMeasureCalculations.pv01MarketQuoteSum(ResolvedOvernightFutureTrade, RatesProvider)"
  })
  void testPv01MarketQuoteSumWithTradeRatesProvider_thenCallsParameterSensitivity() {
    ...
    MultiCurrencyAmount actualPv01MarketQuoteSumResult =
        overnightFutureMeasureCalculations.pv01MarketQuoteSum(null, ratesProvider);
  ...
  void testPv01MarketQuoteSumWithTradeRatesProvider_thenReturnSizeIsZero() {
    ...
    // Act
    MultiCurrencyAmount actualPv01MarketQuoteSumResult =
        overnightFutureMeasureCalculations.pv01MarketQuoteSum(null, new MockRatesProvider());
  ...
  /**
   * Test {@link
   * OvernightFutureMeasureCalculations#pv01MarketQuoteBucketed(ResolvedOvernightFutureTrade,
   * RatesScenarioMarketData)} with {@code trade}, {@code marketData}.
   *
   * <p>Method under test: {@link
   * OvernightFutureMeasureCalculations#pv01MarketQuoteBucketed(ResolvedOvernightFutureTrade,
  ...
  @Test
  @DisplayName(
      "Test pv01MarketQuoteBucketed(ResolvedOvernightFutureTrade, RatesScenarioMarketData) with 'trade', 'marketData'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "ScenarioArray OvernightFutureMeasureCalculations.pv01MarketQuoteBucketed(ResolvedOvernightFutureTrade, RatesScenarioMarketData)"
  })
  void testPv01MarketQuoteBucketedWithTradeMarketData() {
    ...
    ScenarioArray<CurrencyParameterSensitivities> actualPv01MarketQuoteBucketedResult =
        overnightFutureMeasureCalculations.pv01MarketQuoteBucketed(null, marketData);
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "CurrencyParameterSensitivities OvernightFutureMeasureCalculations.pv01MarketQuoteBucketed(ResolvedOvernightFutureTrade, RatesProvider)"
  })
  void testPv01MarketQuoteBucketedWithTradeRatesProvider_givenEmpty_thenReturnEmpty() {
    ...
    CurrencyParameterSensitivities actualPv01MarketQuoteBucketedResult =
        overnightFutureMeasureCalculations.pv01MarketQuoteBucketed(null, ratesProvider);
  ...
  void testPv01MarketQuoteBucketedWithTradeRatesProvider_thenReturnSizeIsZero() {
    ...
    // Act
    CurrencyParameterSensitivities actualPv01MarketQuoteBucketedResult =
        overnightFutureMeasureCalculations.pv01MarketQuoteBucketed(null, new MockRatesProvider());
  ...
  /**
   * Test {@link OvernightFutureMeasureCalculations#unitPrice(ResolvedOvernightFutureTrade,
   * RatesScenarioMarketData)} with {@code trade}, {@code marketData}.
   *
   * <ul>
   *   <li>Given three.
   ...
   *
   * <p>Method under test: {@link
   * OvernightFutureMeasureCalculations#unitPrice(ResolvedOvernightFutureTrade,
   * RatesScenarioMarketData)}
   */
  @Test
  @DisplayName(
      "Test unitPrice(ResolvedOvernightFutureTrade, RatesScenarioMarketData) with 'trade', 'marketData'; given three; then return Values toList size is three")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "DoubleScenarioArray OvernightFutureMeasureCalculations.unitPrice(ResolvedOvernightFutureTrade, RatesScenarioMarketData)"
  })
  void testUnitPriceWithTradeMarketData_givenThree_thenReturnValuesToListSizeIsThree() {
    ...
    DoubleScenarioArray actualUnitPriceResult =
        overnightFutureMeasureCalculations.unitPrice(null, marketData);
  ...
  @Test
  @DisplayName(
      "Test unitPrice(ResolvedOvernightFutureTrade, RatesScenarioMarketData) with 'trade', 'marketData'; then return Values size is one")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "DoubleScenarioArray OvernightFutureMeasureCalculations.unitPrice(ResolvedOvernightFutureTrade, RatesScenarioMarketData)"
   ...
   *
   * <p>Method under test: {@link
   * OvernightFutureMeasureCalculations#unitPrice(ResolvedOvernightFutureTrade, RatesProvider)}
   */
  @Test
  @DisplayName(
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "double OvernightFutureMeasureCalculations.unitPrice(ResolvedOvernightFutureTrade, RatesProvider)"
  })
  void testUnitPriceWithTradeRatesProvider_thenReturnTen() {
    ...
    double actualUnitPriceResult =
        overnightFutureMeasureCalculations.unitPrice(null, new MockRatesProvider());
