...
class BondFutureOptionMarketDataDiffblueTest {
  /**
   * Test {@link BondFutureOptionMarketData#getValuationDate()}.
   *
   * <ul>
   *   <li>Then return toString is {@code 1970-01-01}.
   * </ul>
   *
   * <p>Method under test: {@link BondFutureOptionMarketData#getValuationDate()}
   */
  @Test
  @DisplayName("Test getValuationDate(); then return toString is '1970-01-01'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"LocalDate BondFutureOptionMarketData.getValuationDate()"})
  void testGetValuationDate_thenReturnToStringIs19700101() {
    ...
    LocalDate actualValuationDate =
        DefaultBondFutureOptionMarketData.of(
                DefaultBondFutureOptionMarketDataLookup.of(new HashMap<>()), marketData)
            .getValuationDate();
