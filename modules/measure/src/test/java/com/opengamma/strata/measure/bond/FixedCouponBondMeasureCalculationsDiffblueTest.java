...
class FixedCouponBondMeasureCalculationsDiffblueTest {
  /**
   * Test {@link FixedCouponBondMeasureCalculations#pv01CalibratedSum(ResolvedFixedCouponBondTrade,
   ...
   * FixedCouponBondMeasureCalculations#pv01CalibratedSum(ResolvedFixedCouponBondTrade,
   * LegalEntityDiscountingScenarioMarketData)}
   */
  @Test
  @DisplayName(
      "Test pv01CalibratedSum(ResolvedFixedCouponBondTrade, LegalEntityDiscountingScenarioMarketData) with 'trade', 'marketData'; then return Amounts Size is zero")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "MultiCurrencyScenarioArray FixedCouponBondMeasureCalculations.pv01CalibratedSum(ResolvedFixedCouponBondTrade, LegalEntityDiscountingScenarioMarketData)"
  })
  void testPv01CalibratedSumWithTradeMarketData_thenReturnAmountsSizeIsZero() {
    ...
    MultiCurrencyScenarioArray actualPv01CalibratedSumResult =
        FixedCouponBondMeasureCalculations.DEFAULT.pv01CalibratedSum(
            null,
  ...
  /**
   * Test {@link FixedCouponBondMeasureCalculations#pv01MarketQuoteSum(ResolvedFixedCouponBondTrade,
   * LegalEntityDiscountingScenarioMarketData)} with {@code trade}, {@code marketData}.
   *
   * <ul>
   *   <li>Then return Amounts Size is zero.
   ...
   *
   * <p>Method under test: {@link
   * FixedCouponBondMeasureCalculations#pv01MarketQuoteSum(ResolvedFixedCouponBondTrade,
   * LegalEntityDiscountingScenarioMarketData)}
   */
  @Test
  @DisplayName(
      "Test pv01MarketQuoteSum(ResolvedFixedCouponBondTrade, LegalEntityDiscountingScenarioMarketData) with 'trade', 'marketData'; then return Amounts Size is zero")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "MultiCurrencyScenarioArray FixedCouponBondMeasureCalculations.pv01MarketQuoteSum(ResolvedFixedCouponBondTrade, LegalEntityDiscountingScenarioMarketData)"
  })
  void testPv01MarketQuoteSumWithTradeMarketData_thenReturnAmountsSizeIsZero() {
    ...
    MultiCurrencyScenarioArray actualPv01MarketQuoteSumResult =
        FixedCouponBondMeasureCalculations.DEFAULT.pv01MarketQuoteSum(
            null,
            DefaultLegalEntityDiscountingScenarioMarketData.of(
                lookup, ImmutableScenarioMarketData.empty()));
  ...
  /**
   * Test {@link FixedCouponBondMeasureCalculations#currencyExposure(ResolvedFixedCouponBondTrade,
   * LegalEntityDiscountingScenarioMarketData)} with {@code trade}, {@code marketData}.
   *
   * <ul>
   *   <li>Then return Amounts Size is zero.
   ...
   *
   * <p>Method under test: {@link
   * FixedCouponBondMeasureCalculations#currencyExposure(ResolvedFixedCouponBondTrade,
   * LegalEntityDiscountingScenarioMarketData)}
   */
  @Test
  @DisplayName(
      "Test currencyExposure(ResolvedFixedCouponBondTrade, LegalEntityDiscountingScenarioMarketData) with 'trade', 'marketData'; then return Amounts Size is zero")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "MultiCurrencyScenarioArray FixedCouponBondMeasureCalculations.currencyExposure(ResolvedFixedCouponBondTrade, LegalEntityDiscountingScenarioMarketData)"
  })
  void testCurrencyExposureWithTradeMarketData_thenReturnAmountsSizeIsZero() {
    ...
    MultiCurrencyScenarioArray actualCurrencyExposureResult =
        FixedCouponBondMeasureCalculations.DEFAULT.currencyExposure(
            null,
            DefaultLegalEntityDiscountingScenarioMarketData.of(
                lookup, ImmutableScenarioMarketData.empty()));
