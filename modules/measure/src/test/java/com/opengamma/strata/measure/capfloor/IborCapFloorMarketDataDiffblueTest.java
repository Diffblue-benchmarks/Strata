...
class IborCapFloorMarketDataDiffblueTest {
  /**
   * Test {@link IborCapFloorMarketData#getValuationDate()}.
   *
   * <ul>
   *   <li>Then return toString is {@code 1970-01-01}.
   * </ul>
   *
   * <p>Method under test: {@link IborCapFloorMarketData#getValuationDate()}
   */
  @Test
  @DisplayName("Test getValuationDate(); then return toString is '1970-01-01'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"LocalDate IborCapFloorMarketData.getValuationDate()"})
  void testGetValuationDate_thenReturnToStringIs19700101() {
    ...
    LocalDate actualValuationDate =
        DefaultIborCapFloorMarketData.of(
                DefaultIborCapFloorMarketDataLookup.of(new HashMap<>()), marketData)
            .getValuationDate();
