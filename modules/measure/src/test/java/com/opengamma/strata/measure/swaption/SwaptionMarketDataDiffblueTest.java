...
class SwaptionMarketDataDiffblueTest {
  /**
   * Test {@link SwaptionMarketData#getValuationDate()}.
   *
   * <ul>
   *   <li>Then return toString is {@code 1970-01-01}.
   * </ul>
   *
   * <p>Method under test: {@link SwaptionMarketData#getValuationDate()}
   */
  @Test
  @DisplayName("Test getValuationDate(); then return toString is '1970-01-01'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"LocalDate SwaptionMarketData.getValuationDate()"})
  void testGetValuationDate_thenReturnToStringIs19700101() {
    ...
    LocalDate actualValuationDate =
        DefaultSwaptionMarketData.of(
                DefaultSwaptionMarketDataLookup.of(new HashMap<>()), marketData)
            .getValuationDate();
