...
class IborFutureOptionMarketDataDiffblueTest {
  /**
   * Test {@link IborFutureOptionMarketData#getValuationDate()}.
   *
   * <ul>
   *   <li>Then return toString is {@code 1970-01-01}.
   * </ul>
   *
   * <p>Method under test: {@link IborFutureOptionMarketData#getValuationDate()}
   */
  @Test
  @DisplayName("Test getValuationDate(); then return toString is '1970-01-01'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"LocalDate IborFutureOptionMarketData.getValuationDate()"})
  void testGetValuationDate_thenReturnToStringIs19700101() {
    ...
    LocalDate actualValuationDate =
        DefaultIborFutureOptionMarketData.of(
                DefaultIborFutureOptionMarketDataLookup.of(new HashMap<>()), marketData)
            .getValuationDate();
