...
class ProbabilityDiffblueTest {
   ...
   * <ul>
   *   <li>When {@code 3.3306690738754696E-16}.
   *   <li>Then return {@code 4.975370381131898E-27}.
   * </ul>
   *
   * <p>Method under test: {@link Probability#binomialComplemented(int, int, double)}
   */
  @Test
  @DisplayName(
      "Test binomialComplemented(int, int, double); when '3.3306690738754696E-16'; then return '4.975370381131898E-27'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"double Probability.binomialComplemented(int, int, double)"})
  void testBinomialComplemented_when33306690738754696e16_thenReturn4975370381131898e27() {
    // Arrange, Act and Assert
    assertEquals(
        4.975370381131898E-27d, Probability.binomialComplemented(1, 300, 3.3306690738754696E-16d));
  }
   ...
   */
  @Test
  @DisplayName("Test chiSquare(double, double); when one; then return '0.842700792949715'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"double Probability.chiSquare(double, double)"})
  void testChiSquare_whenOne_thenReturn0842700792949715() throws ArithmeticException {
    // Arrange, Act and Assert
    assertEquals(0.842700792949715d, Probability.chiSquare(1.0d, 2.0d));
  }
