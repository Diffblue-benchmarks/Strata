...
class StudentTDiffblueTest {
   ...
   *
   * <ul>
   *   <li>Then return {@code 0.6997255047633842}.
   * </ul>
   *
   * <p>Method under test: {@link StudentT#nextDouble(double)}
   */
  @Test
  @DisplayName("Test nextDouble(double) with 'double'; then return '0.6997255047633842'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"double StudentT.nextDouble(double)"})
  void testNextDoubleWithDouble_thenReturn06997255047633842() {
    // Arrange
    ...
    // Act and Assert
    assertEquals(0.6997255047633842d, studentT.nextDouble(10.0d));
  }
   ...
   *
   * <ul>
   *   <li>Then return {@code -1.2433578683958169}.
   * </ul>
   *
   * <p>Method under test: {@link StudentT#nextDouble(double)}
   */
  @Test
  @DisplayName("Test nextDouble(double) with 'double'; then return '-1.2433578683958169'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"double StudentT.nextDouble(double)"})
  void testNextDoubleWithDouble_thenReturn12433578683958169() {
    // Arrange
    StudentT studentT = new StudentT(10.0d, new MersenneTwister64());

    // Act and Assert
    assertEquals(-1.2433578683958169d, studentT.nextDouble(10.0d));
  }
   ...
   */
  @Test
  @DisplayName("Test nextDouble(); then return '0.6997255047633842'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"double StudentT.nextDouble()"})
  void testNextDouble_thenReturn06997255047633842() {
    // Arrange
    Date d = Date.from(LocalDate.of(1970, 1, 1).atStartOfDay().atZone(ZoneOffset.UTC).toInstant());
    MersenneTwister randomGenerator = new MersenneTwister(d);
    StudentT studentT = new StudentT(10.0d, randomGenerator);
    ...
    // Act and Assert
    assertEquals(0.6997255047633842d, studentT.nextDouble());
  }
   ...
   */
  @Test
  @DisplayName("Test nextDouble(); then return '-1.2433578683958169'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"double StudentT.nextDouble()"})
  void testNextDouble_thenReturn12433578683958169() {
    // Arrange
    StudentT studentT = new StudentT(10.0d, new MersenneTwister64());

    // Act and Assert
    assertEquals(-1.2433578683958169d, studentT.nextDouble());
  }
  ...
  void testPdf() {
    ...
    // Act and Assert
    assertEquals(0.06114576632115147d, studentT.pdf(2.0d));
  }
