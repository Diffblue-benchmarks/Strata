...
class BesselDiffblueTest {
   ...
   * <ul>
   *   <li>When ten.
   *   <li>Then return {@code 2.7252700261657538E-5}.
   * </ul>
   *
   * <p>Method under test: {@link Bessel#kn(int, double)}
   */
  @Test
  @DisplayName("Test kn(int, double); when ten; then return '2.7252700261657538E-5'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"double Bessel.kn(int, double)"})
  void testKn_whenTen_thenReturn27252700261657538e5() throws ArithmeticException {
    // Arrange, Act and Assert
    assertEquals(2.7252700261657538E-5d, Bessel.kn(3, 10.0d));
  }
   ...
   * <ul>
   *   <li>When eight.
   *   <li>Then return {@code 0.22352148924968093}.
   * </ul>
   *
   * <p>Method under test: {@link Bessel#y0(double)}
   */
  @Test
  @DisplayName("Test y0(double); when eight; then return '0.22352148924968093'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"double Bessel.y0(double)"})
  void testY0_whenEight_thenReturn022352148924968093() throws ArithmeticException {
    // Arrange, Act and Assert
    assertEquals(0.22352148924968093d, Bessel.y0(8.0d));
  }
   ...
   */
  @Test
  @DisplayName("Test yn(int, double); when eight; then return '0.22352148924968093'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"double Bessel.yn(int, double)"})
  void testYn_whenEight_thenReturn022352148924968093() throws ArithmeticException {
    // Arrange, Act and Assert
    assertEquals(0.22352148924968093d, Bessel.yn(0, 8.0d));
  }
