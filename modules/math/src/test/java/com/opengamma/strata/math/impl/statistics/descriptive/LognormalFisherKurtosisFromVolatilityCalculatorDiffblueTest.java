...
class LognormalFisherKurtosisFromVolatilityCalculatorDiffblueTest {
   ...
   * <ul>
   *   <li>When one.
   *   <li>Then return {@code 2.35406641241678688E17}.
   * </ul>
   *
   * <p>Method under test: {@link
   * LognormalFisherKurtosisFromVolatilityCalculator#applyAsDouble(double, double)}
   */
  @Test
  @DisplayName("Test applyAsDouble(double, double); when one; then return '2.35406641241678688E17'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "double LognormalFisherKurtosisFromVolatilityCalculator.applyAsDouble(double, double)"
  })
  void testApplyAsDouble_whenOne_thenReturn235406641241678688e17() {
    // Arrange, Act and Assert
    assertEquals(
        2.35406641241678688E17d,
