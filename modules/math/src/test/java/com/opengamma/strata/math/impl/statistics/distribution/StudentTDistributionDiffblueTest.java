...
class StudentTDistributionDiffblueTest {
   ...
   * <ul>
   *   <li>When two.
   *   <li>Then return {@code 0.06114576632115147}.
   * </ul>
   *
   * <p>Method under test: {@link StudentTDistribution#getPDF(Double)}
   */
  @Test
  @DisplayName("Test getPDF(Double) with 'Double'; when two; then return '0.06114576632115147'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"double StudentTDistribution.getPDF(Double)"})
  void testGetPDFWithDouble_whenTwo_thenReturn006114576632115147() {
    // Arrange, Act and Assert
    assertEquals(0.06114576632115147d, new StudentTDistribution(10.0d).getPDF(2.0d));
  }
