...
class NormalDistributionDiffblueTest {
   ...
   *
   * <ul>
   *   <li>Then return {@code 1.482428803115965}.
   * </ul>
   *
   * <p>Method under test: {@link NormalDistribution#nextRandom()}
   */
  @Test
  @DisplayName("Test nextRandom(); then return '1.482428803115965'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"double NormalDistribution.nextRandom()"})
  void testNextRandom_thenReturn1482428803115965() {
    // Arrange, Act and Assert
    assertEquals(
        1.482428803115965d,
        new NormalDistribution(2.0d, 2.0d, new MersenneTwister64(42)).nextRandom());
  }
