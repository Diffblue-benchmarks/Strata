...
class GammaFunctionsDiffblueTest {
   ...
   *   <li>Then return {@code 2.919114949633027E245}.
   * </ul>
   *
   * <p>Method under test: {@link GammaFunctions#gamma(double)}
   */
  @Test
  @DisplayName("Test gamma(double); when '143.01608'; then return '2.919114949633027E245'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"double GammaFunctions.gamma(double)"})
  void testGamma_when14301608_thenReturn2919114949633027e245() throws ArithmeticException {
    // Arrange, Act and Assert
    assertEquals(2.919114949633027E245d, GammaFunctions.gamma(143.01608d));
  }
   ...
   * <ul>
   *   <li>When two.
   *   <li>Then return {@code 1.0000025832104016}.
   * </ul>
   *
   * <p>Method under test: {@link GammaFunctions#stirlingFormula(double)}
   */
  @Test
  @DisplayName("Test stirlingFormula(double); when two; then return '1.0000025832104016'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"double GammaFunctions.stirlingFormula(double)"})
  void testStirlingFormula_whenTwo_thenReturn10000025832104016() throws ArithmeticException {
    // Arrange, Act and Assert
    assertEquals(1.0000025832104016d, GammaFunctions.stirlingFormula(2.0d));
  }
}
