...
class NonCentralChiSquaredDistributionDiffblueTest {
   ...
   *
   * <ul>
   *   <li>Then return {@code 0.0656311134075037}.
   * </ul>
   *
   * <p>Method under test: {@link NonCentralChiSquaredDistribution#getCDF(Double)}
   */
  @Test
  @DisplayName("Test getCDF(Double) with 'Double'; then return '0.0656311134075037'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"double NonCentralChiSquaredDistribution.getCDF(Double)"})
  void testGetCDFWithDouble_thenReturn00656311134075037() {
    // Arrange, Act and Assert
    assertEquals(
        0.0656311134075037d,
        new NonCentralChiSquaredDistribution(2.7541252083279814E-5d, 10.0d).getCDF(2.0d));
  }
   ...
   *
   * <ul>
   *   <li>Then return {@code 5.334598157387009E-5}.
   * </ul>
   *
   * <p>Method under test: {@link NonCentralChiSquaredDistribution#getCDF(Double)}
   */
  @Test
  @DisplayName("Test getCDF(Double) with 'Double'; then return '5.334598157387009E-5'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"double NonCentralChiSquaredDistribution.getCDF(Double)"})
  void testGetCDFWithDouble_thenReturn5334598157387009e5() {
    // Arrange, Act and Assert
    assertEquals(
        5.334598157387009E-5d, new NonCentralChiSquaredDistribution(10.0d, 10.0d).getCDF(2.0d));
  }
   ...
   *
   * <ul>
   *   <li>Then return {@code 0.023349945229355594}.
   * </ul>
   *
   * <p>Method under test: {@link NonCentralChiSquaredDistribution#getCDF(Double)}
   */
  @Test
  @DisplayName("Test getCDF(Double) with 'Double'; then return '0.023349945229355594'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"double NonCentralChiSquaredDistribution.getCDF(Double)"})
  void testGetCDFWithDouble_thenReturn0023349945229355594() {
    // Arrange, Act and Assert
    assertEquals(
        0.023349945229355594d, new NonCentralChiSquaredDistribution(2.0d, 10.0d).getCDF(2.0d));
  }
   ...
   *
   * <ul>
   *   <li>Then return {@code 0.41791880371346796}.
   * </ul>
   *
   * <p>Method under test: {@link NonCentralChiSquaredDistribution#getCDF(Double)}
   */
  @Test
  @DisplayName("Test getCDF(Double) with 'Double'; then return '0.41791880371346796'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"double NonCentralChiSquaredDistribution.getCDF(Double)"})
  void testGetCDFWithDouble_thenReturn041791880371346796() {
    // Arrange, Act and Assert
    assertEquals(
        0.41791880371346796d, new NonCentralChiSquaredDistribution(1000.0d, 10.0d).getCDF(1000.0d));
  }
   ...
   *   <li>Then return {@code 1.0000000000000002}.
   * </ul>
   *
   * <p>Method under test: {@link NonCentralChiSquaredDistribution#getCDF(Double)}
   */
  @Test
  @DisplayName(
      "Test getCDF(Double) with 'Double'; when one thousand; then return '1.0000000000000002'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"double NonCentralChiSquaredDistribution.getCDF(Double)"})
  void testGetCDFWithDouble_whenOneThousand_thenReturn10000000000000002() {
    // Arrange, Act and Assert
    assertEquals(
        1.0000000000000002d, new NonCentralChiSquaredDistribution(10.0d, 10.0d).getCDF(1000.0d));
  }
