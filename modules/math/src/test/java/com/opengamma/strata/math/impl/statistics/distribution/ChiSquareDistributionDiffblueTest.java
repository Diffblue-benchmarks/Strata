...
class ChiSquareDistributionDiffblueTest {
   ...
   * <ul>
   *   <li>When {@code 0.5}.
   *   <li>Then return {@code 9.34181776559232}.
   * </ul>
   *
   * <p>Method under test: {@link ChiSquareDistribution#getInverseCDF(Double)}
   */
  @Test
  @DisplayName(
      "Test getInverseCDF(Double) with 'Double'; when '0.5'; then return '9.34181776559232'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"double ChiSquareDistribution.getInverseCDF(Double)"})
  void testGetInverseCDFWithDouble_when05_thenReturn934181776559232() {
    // Arrange, Act and Assert
    assertEquals(9.34181776559232d, new ChiSquareDistribution(10.0d).getInverseCDF(0.5d));
  }
   ...
   *
   * <ul>
   *   <li>Then return {@code 2.006525522306219}.
   * </ul>
   *
   * <p>Method under test: {@link ChiSquareDistribution#nextRandom()}
   */
  @Test
  @DisplayName("Test nextRandom(); then return '2.006525522306219'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"double ChiSquareDistribution.nextRandom()"})
  void testNextRandom_thenReturn2006525522306219() {
    // Arrange
    ChiSquareDistribution chiSquareDistribution =
        new ChiSquareDistribution(1.0750541497296464d, new MersenneTwister64(42));

    // Act and Assert
    assertEquals(2.006525522306219d, chiSquareDistribution.nextRandom());
  }
   ...
   */
  @Test
  @DisplayName("Test nextRandom(); then return '12.724614017294025'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"double ChiSquareDistribution.nextRandom()"})
  void testNextRandom_thenReturn12724614017294025() {
    // Arrange
    Date d = Date.from(LocalDate.of(1970, 1, 1).atStartOfDay().atZone(ZoneOffset.UTC).toInstant());
    MersenneTwister64 engine = new MersenneTwister64(d);
    ChiSquareDistribution chiSquareDistribution = new ChiSquareDistribution(10.0d, engine);

    // Act and Assert
    assertEquals(12.724614017294025d, chiSquareDistribution.nextRandom());
  }
