...
class FunDiffblueTest {
   ...
   * <ul>
   *   <li>When one.
   *   <li>Then return {@code 10.196562852370747}.
   * </ul>
   *
   * <p>Method under test: {@link Fun#bessel2_fkt(double, double)}
   */
  @Test
  @DisplayName("Test bessel2_fkt(double, double); when one; then return '10.196562852370747'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"double Fun.bessel2_fkt(double, double)"})
  void testBessel2_fkt_whenOne_thenReturn10196562852370747() {
    // Arrange, Act and Assert
    assertEquals(10.196562852370747d, Fun.bessel2_fkt(1.0d, 10.0d));
  }
   ...
   * <ul>
   *   <li>When {@link Math#PI}.
   *   <li>Then return {@code 2.7950196623919603}.
   * </ul>
   *
   * <p>Method under test: {@link Fun#bessel2_fkt(double, double)}
   */
  @Test
  @DisplayName("Test bessel2_fkt(double, double); when PI; then return '2.7950196623919603'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"double Fun.bessel2_fkt(double, double)"})
  void testBessel2_fkt_whenPi_thenReturn27950196623919603() {
    // Arrange, Act and Assert
    assertEquals(2.7950196623919603d, Fun.bessel2_fkt(0.5d, 3.141592653589793d));
  }
   ...
   * <ul>
   *   <li>When ten.
   *   <li>Then return {@code 362880.0000009803}.
   * </ul>
   *
   * <p>Method under test: {@link Fun#gamma(double)}
   */
  @Test
  @DisplayName("Test gamma(double); when ten; then return '362880.0000009803'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"double Fun.gamma(double)"})
  void testGamma_whenTen_thenReturn3628800000009803() {
    // Arrange, Act and Assert
    assertEquals(362880.0000009803d, Fun.gamma(10.0d));
  }
