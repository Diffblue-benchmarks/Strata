...
class NormalRandomNumberGeneratorDiffblueTest {
  ...
  void testGetVectors() {
    ...
    assertArrayEquals(
        new double[] {0.20019159666862185d, 4.2197508412526386d, 0.5434223593333343d},
   ...
   */
  @Test
  @DisplayName("Test getVectors(int, int); when one; then return size is three")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"List NormalRandomNumberGenerator.getVectors(int, int)"})
  void testGetVectors_whenOne_thenReturnSizeIsThree() {
    // Arrange, Act and Assert
    assertEquals(3, new NormalRandomNumberGenerator(10.0d, 10.0d).getVectors(1, 3).size());
  }
}
