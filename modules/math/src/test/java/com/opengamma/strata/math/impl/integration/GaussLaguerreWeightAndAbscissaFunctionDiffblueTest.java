...
class GaussLaguerreWeightAndAbscissaFunctionDiffblueTest {
   ...
   *
   * <ul>
   *   <li>Then return Weights is array of {@code double} with {@code 2.9812064268103327}.
   * </ul>
   *
   * <p>Method under test: {@link GaussLaguerreWeightAndAbscissaFunction#generate(int)}
   */
  @Test
  @DisplayName(
      "Test generate(int); then return Weights is array of double with '2.9812064268103327'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"GaussianQuadratureData GaussLaguerreWeightAndAbscissaFunction.generate(int)"})
  void testGenerate_thenReturnWeightsIsArrayOfDoubleWith29812064268103327() {
    // Arrange and Act
    GaussianQuadratureData actualGenerateResult =
    ...
    // Assert
    assertArrayEquals(new double[] {1.0d}, actualGenerateResult.getAbscissas(), 0.0);
    assertArrayEquals(new double[] {2.9812064268103327d}, actualGenerateResult.getWeights(), 0.0);
  }
