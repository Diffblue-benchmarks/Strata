...
class GammaDiffblueTest {
   ...
   *
   * <ul>
   *   <li>Then return {@code 0.7609758217744363}.
   * </ul>
   *
   * <p>Method under test: {@link Gamma#nextDouble(double, double)}
   */
  @Test
  @DisplayName(
      "Test nextDouble(double, double) with 'double', 'double'; then return '0.7609758217744363'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"double Gamma.nextDouble(double, double)"})
  void testNextDoubleWithDoubleDouble_thenReturn07609758217744363() {
    // Arrange
    ...
    // Act and Assert
    assertEquals(
        0.7609758217744363d, new Gamma(10.0d, 10.0d, randomGenerator).nextDouble(10.0d, 10.0d));
  }
   ...
   */
  @Test
  @DisplayName("Test nextDouble(); then return '0.7609758217744363'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"double Gamma.nextDouble()"})
  void testNextDouble_thenReturn07609758217744363() {
    // Arrange
    LocalDate ofEpochDayResult = LocalDate.ofEpochDay(1L);
    Date d = Date.from(ofEpochDayResult.atStartOfDay().atZone(ZoneOffset.UTC).toInstant());
    MersenneTwister randomGenerator = new MersenneTwister(d);
    ...
    // Act and Assert
    assertEquals(0.7609758217744363d, new Gamma(10.0d, 10.0d, randomGenerator).nextDouble());
  }
  ...
  void testStaticNextDouble_when05_thenDoesNotThrow() {
    // Arrange, Act and Assert
    assertDoesNotThrow(() -> Gamma.staticNextDouble(0.5d, 10.0d));
  }
  ...
  void testStaticNextDouble_when05_thenDoesNotThrow2() {
    // Arrange, Act and Assert
    assertDoesNotThrow(() -> Gamma.staticNextDouble(10.0d, -0.5d));
  }
  ...
  void testStaticNextDouble_when05_thenDoesNotThrow3() {
    // Arrange, Act and Assert
    assertDoesNotThrow(() -> Gamma.staticNextDouble(0.5d, -1.0d));
  }
   ...
   */
  @Test
  @DisplayName("Test staticNextDouble(double, double); when '2.47453E-4'; then does not throw")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"double Gamma.staticNextDouble(double, double)"})
  void testStaticNextDouble_when247453e4_thenDoesNotThrow() {
    // Arrange, Act and Assert
    assertDoesNotThrow(() -> Gamma.staticNextDouble(1.0d, 2.47453E-4d));
  }
   ...
   */
  @Test
  @DisplayName("Test staticNextDouble(double, double); when '3.340332E-4'; then does not throw")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"double Gamma.staticNextDouble(double, double)"})
  void testStaticNextDouble_when3340332e4_thenDoesNotThrow() {
    // Arrange, Act and Assert
    assertDoesNotThrow(() -> Gamma.staticNextDouble(0.5d, 3.340332E-4d));
  }
  ...
  void testStaticNextDouble_when00079849875_thenDoesNotThrow() {
    // Arrange, Act and Assert
    assertDoesNotThrow(() -> Gamma.staticNextDouble(0.0079849875d, 0.333333333d));
  }
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"double Gamma.staticNextDouble(double, double)"})
  void testStaticNextDouble_when00208333723_thenDoesNotThrow2() {
    // Arrange, Act and Assert
    assertDoesNotThrow(() -> Gamma.staticNextDouble(10.0d, 0.0208333723d));
  }
  ...
  void testStaticNextDouble_whenOne_thenDoesNotThrow() {
    // Arrange, Act and Assert
    assertDoesNotThrow(() -> Gamma.staticNextDouble(1.0d, -1.0d));
  }
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"double Gamma.staticNextDouble(double, double)"})
  void testStaticNextDouble_whenOne_thenDoesNotThrow2() {
    // Arrange, Act and Assert
    assertDoesNotThrow(() -> Gamma.staticNextDouble(1.0d, 1.0d));
  }
   ...
   */
  @Test
  @DisplayName("Test staticNextDouble(double, double); when zero; then return POSITIVE_INFINITY")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"double Gamma.staticNextDouble(double, double)"})
  void testStaticNextDouble_whenZero_thenReturnPositive_infinity() {
    // Arrange, Act and Assert
    assertEquals(Double.POSITIVE_INFINITY, Gamma.staticNextDouble(1.0d, 0.0d));
  }
